...
// Übernommen aus E:\materialbedarf\db.js (gleiches Gateway-Muster), nur mit
// eigener GATEWAY_APP_ID.
const GATEWAY_URL = "https://landingpage.michel-brunner.workers.dev";
const TOKEN_STORAGE_KEY = "tu_session_token";
const GATEWAY_APP_ID = "ausbildungsplan";
...
// Materialliste/db.js und elf weiteren Apps -- es gibt keinen Build-Step, also
// wird kopiert. Wer eine Fassung aendert, zieht die anderen mit.
...
//
// ⚠️ HIER MIT EINEM FELD MEHR als in den anderen Fassungen: `stufe`. Die zentrale
// Liste leitet aus dem Kurznamen den Buchstaben ab ("a".."g", "herren",
// "maedchen", "sonstige") -- und genau diese Buchstaben sind die Ids der
// Juniorenstufen in dieser App (siehe seed.js). Damit belegt das Formular die
// Stufe selbst vor, statt sie raten zu lassen.
//
// Diese App fuehrt ihre Mannschaften weiterhin SELBST: an ihnen haengen Stufe,
// Jahrgaenge und alle Spieltag-Boegen. Die Liste ist deshalb ein VORSCHLAG,
// keine Schranke -- ein frei getippter Name bleibt moeglich.
//
...
async function fetchVereinsMannschaften() {
  try {
    ...
    return teams
      ...
      .map((t) => ({
        kurz: String(t.kurz),
        lang: String(t.lang || t.kurz),
        liga: String(t.liga || ""),
        stufe: String(t.stufe || "")
      }));
  } catch (e) {
